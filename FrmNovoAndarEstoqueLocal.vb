Public Class FrmNovoAndarEstoqueLocal
    ...
    Private Sub BttBuscarCliente_Click(sender As Object, e As EventArgs) Handles BttBuscarCliente.Click
        ...
        For i As Integer = 1 To NmQtInserir.Value
            ...
            LqEstoque.InsereNovaAndarEstoqueLocal(IdPredio, IdEstoque, "Andar_" & i + FrmAndarEstoqueLocal.ListView2.Items.Count)

        Next

        FrmAndarEstoqueLocal.CarregaInicio()

        Me.Close()

    End Sub

    Private Sub FrmNovoAndarEstoqueLocal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
