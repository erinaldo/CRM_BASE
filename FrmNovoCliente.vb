Public Class FrmNovoCliente
    ...
    Private Sub BttSalvarColaborador_Click(sender As Object, e As EventArgs) Handles BttSalvarColaborador.Click
        ...
        If CmbColaboradores.Text = "" Then
            ...
            LqCadastros.InsereCliente(TxtNomeCompleto.Text, TxtCPF.Text, TxtIE.Text, RdbJuridica.Checked, TxtCep.Text, LstIdEndereço.Items(CmbEndereço.SelectedIndex).ToString, CmbEndereço.Text, TxtNumero.Text, TxtComplemento.Text, CmbBairro.Text, CmbCidade.Text, CmbEstado.Text, CmbPais.Text, TxtTelefone.Text, TxtCelular.Text, TxtEmail.Text, 0, "")

            _Select = TxtNomeCompleto.Text

        Else

            LqCadastros.AtualizaCliente(LstIdFuncionarios.Items(CmbColaboradores.SelectedIndex).ToString, TxtNomeCompleto.Text, TxtCPF.Text, TxtIE.Text, RdbJuridica.Checked, TxtCep.Text, LstIdEndereço.Items(CmbEndereço.SelectedIndex).ToString, CmbEndereço.Text, TxtNumero.Text, TxtComplemento.Text, CmbBairro.Text, CmbCidade.Text, CmbEstado.Text, CmbPais.Text, TxtTelefone.Text, TxtCelular.Text, TxtEmail.Text)

        End If

        'carrega colaboradores

        Dim BuscaColaboradores = From col In LqCadastros.Clientes
                                 Where col.IdCliente Like "*"
                                 Select col.RazaoSocial_nome, col.IdCliente

        LstIdFuncionarios.Items.Clear()
        CmbColaboradores.Items.Clear()

        For Each row In BuscaColaboradores.ToList
            LstIdFuncionarios.Items.Add(row.IdCliente)
    ...
    Private Sub BttEditColaborador_Click(sender As Object, e As EventArgs) Handles BttEditColaborador.Click
        ...
        Dim BUscaColaborador = From col In LqCadastros.Clientes
                               Where col.IdCliente = LstIdFuncionarios.Items(CmbColaboradores.SelectedIndex).ToString
                               Select col.RazaoSocial_nome, col.CPF_CNPJ, col.RG_IE, col.TipoPersonalidade, col.CEP, col.Numero, col.Complemento, col.Telefone, col.Celular, col.Email
